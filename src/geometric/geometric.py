...
class Geometria:
    ...
    def area_pentagono_regular(self, lado, apotema):
        ...
        """
        # Fórmula: (perímetro * apotema) / 2, con perímetro = 5 * lado.
    ...
    def area_hexagono_regular(self, lado, apotema):
        ...
        """
        # Perímetro = 6 * lado; Área = (perímetro * apotema) / 2
    ...
    def pendiente_recta(self, x1, y1, x2, y2):
        ...
        """
        if x2 - x1 == 0:
            raise ZeroDivisionError("División por cero en la pendiente")
        return (y2 - y1) / (x2 - x1)
    ...
    def area_poligono_regular(self, num_lados, lado, apotema):
        ...
        # Según la especificación de tests, si es un cuadrado (4 lados) se espera:
        # Área = perimetro * apotema en lugar de (perimetro * apotema) / 2.
        if num_lados == 4:
